"""
Government Science College (GSC) Multi-Batch Automation Scraper
Website: https://gsctd.eshiksaems.com
Credentials: gsctdstudent / gsctdstudent
...
BASE_URL = "https://gsctd.eshiksaems.com"
...
class PortalSession:
    ...
    def authenticate(self):
        ...
        with sync_playwright() as pw:
            ...
            page.locator("input[name=username]").fill("gsctdstudent")
            page.locator("input[name=password]").fill("gsctdstudent")
